...
class Restaurant(models.Model):
    ...
    picture = models.URLField(max_length = 200, default='https://assets.architecturaldigest.in/photos/67c55d02484735032005928d/4:3/w_1440,h_1080,c_limit/cover%20image%20template.jpg')
